...
class ScipyDistribution(Distribution, AvoidAbstractMixin):
    ...
    base_module: _continuous_distns.rv_continuous
...
Loguniform = _wrap_scipy_distribution(_stats.loguniform)
...
VonmisesLine = _wrap_scipy_distribution(_stats.vonmises_line)
